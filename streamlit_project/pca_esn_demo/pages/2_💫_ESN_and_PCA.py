...
with esn_pca_tab:
    st.markdown(
        ...
        - You can specify the Nr of PCs
        - It will always calculate the normal and the pca component with output bias. 
        - We will manually train the esn's to use different kinds of regressions. 
