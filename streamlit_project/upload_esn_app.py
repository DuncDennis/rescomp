    ...
    with st.sidebar:
        ...
        if uploaded_file is not None:
            ...
            if len(data_shape) != 2:
                ...
                data_uploaded = True
                # raise ValueError("Uploaded file has the wrong shape. It needs to have the shape"
                #                  "(time steps, data dimension")
            if data_uploaded:
        ...
        if data_uploaded:
            simulate_data_checkbox_key = f"None__st_main_checkboxes__sim"
            st.session_state[simulate_data_checkbox_key] = True
