...
if __name__ == "__main__":
    ...
    name = "22_06_2022_lorenz_w_out_summed_2"
    seed = 110
    N_ens = 5000
    print("Simulating Data")

    x_train, x_pred_list = st.data_simulation_new(**simulation_args, sim_data_return=False, starting_point="standard",
    ...
    np.random.seed(seed)
    sweep_tester = st.PCAWoutMeasurement_summed()
