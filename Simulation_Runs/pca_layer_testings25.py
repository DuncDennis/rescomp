...
parameters = {
    "type": ["pca_layer_var_norm", "pca_layer_normal", "normal"],
    "r_dim": [500],
    # "norm_with_expl_var": [True],
    "r_to_r_gen_opt": "output_bias",
    "centering_pre_trans": [True],
    "act_fct_opt": "tanh",
    "node_bias_opt": "constant_bias",
    "bias_scale": 0.1,
    "reg_param": [1e-16, 1e-14, 1e-12, 1e-10, 1e-8, 1e-6],
...
def model_creation_function(**kwargs):
    ...
    elif kwargs["type"] == "pca_layer_var_norm":
        esn = ESN.ESN_pca()
        kwargs["norm_with_expl_var"] = True

    elif kwargs["type"] == "pca_layer_normal":
        esn = ESN.ESN_pca()
        kwargs["norm_with_expl_var"] = False
...
if __name__ == "__main__":
    ...
    name = "14_06_2022_Chua_reg_param_sweep"
    seed = 110
    N_ens = 20
