...
parameters = {
    ...
    "r_dim_or_pca_comps": [50, 100, 150, 200, 250, 300, 350, 400, 450, 500],
    "r_dim_for_pca": 500,
...
if __name__ == "__main__":
    ...
    name = "08_06_2022_Chen_rp_vs_p_valid_times"
    seed = 106
    N_ens = 1
    ...
    sweep_tester.do_ens_experiment_sweep(N_ens, x_pred_list, results_type="validtimes", error_threshhold=error_threshhold,
                                         **{**parameters, **simulation_args})
    print("Experiment Finished!")

    sweep_tester.save_sweep_results(name=name, results_type="validtimes")
