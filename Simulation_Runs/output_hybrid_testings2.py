...
parameters = {
    "type": ["output_hybrid", "input_hybrid", "full_hybrid", "output_hybrid_pca", "input_hybrid_pca", "full_hybrid_pca"],
    "eps": [0.01, 0.02, 0.04, 0.06, 0.08, 0.1],
    "r_dim": 50,
